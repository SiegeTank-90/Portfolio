    ...
    return (
        <div className='Information'>
            <>
                ...
                <div className='Information--Buttons-Row'>
                    <a href="docs/Milestone1_Narraitve_SoftwareDesignAndEngneering.pdf" target='_blank' rel='noreferrer'>
                    <button className='Information--Buttons-Row--Button--Footer'>
                        <FontAwesomeIcon icon={faFile} size='2x' />
                        <p className='Information--Buttons-Row--Name'>Milestone 1</p>
                    </button>
                    </a>
                    <a href="docs/MileStone2_Narrative_AlgorithmsAndDataStructures.pdf" target='_blank' rel='noreferrer'>
                    <button className='Information--Buttons-Row--Button--Footer'>
                        <FontAwesomeIcon icon={faFile} size='2x' />
                        <p className='Information--Buttons-Row--Name'>Milestone_2</p>
                    </button>
                    </a>
                    <a href="docs/Milestone_3_Narrative_Databaes.pdf" target='_blank' rel='noreferrer'>
                    <button className='Information--Buttons-Row--Button--Footer'>
                        <FontAwesomeIcon icon={faFile} size='2x' />
                        <p className='Information--Buttons-Row--Name'>Milestone 3</p>
                    </button>
                    </a>
                    <a href="docs/ProfessionalAssesments.pdf" target='_blank' rel='noreferrer'>
                    <button className='Information--Buttons-Row--Button--Footer'>
                        <FontAwesomeIcon icon={faFile} size='2x' />
